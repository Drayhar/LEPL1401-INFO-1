...
class TestTurtleBot(unittest.TestCase):
    ...
    def test_turnleft(self):
        ...
        self.assertAlmostEqual(self.t.getangle(), expected_angle, 0, "Your turtleBot took a wrong turn or did not update its angle while turning left")
    ...
    def test_turnright(self):
        ...
        expected_angle = (self.t.getangle() + 90) % 360
        self.t.turnright()
        self.assertAlmostEqual(self.t.getangle(), expected_angle, 0, "Your turtleBot took a wrong turn or did not update its angle while turning right")
    ...
    def test_turn(self):
        ...
        self.t.turnright()
        self.t.turnright()
        self.assertAlmostEqual(self.t.getangle(), expected_angle, 0, "Your turtleBot took a wrong turn or did not update its angle")
    ...
    def test_moveforward(self):
        ...
        self.assertAlmostEqual(self.t.getangle(), expected_angle, 0, "Your turtleBot changed heading while moving forward")
    ...
    def test_movebackward(self):
        ...
        self.assertAlmostEqual(self.t.getangle(), expected_angle, 0, "Your turtleBot changed heading while moving backward")
